...
import { TREND_SOURCE_SERVER, calculateTrendDelta, claimStatusClass, formatWon, roundMoney, trendDirectionLabel } from './utils';
...
describe('web utils', () => {
  ...
  it('트렌드 계산은 증가율을 정수 기반 퍼센트로 계산한다', () => {
    expect(calculateTrendDelta(120, 100)).toMatchObject({ delta: 20, deltaRate: 20, direction: 'up' });
  });
